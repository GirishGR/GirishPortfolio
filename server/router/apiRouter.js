...
/*
    ...
    Fields : no-fields
 */
router.get('/contactDetails', async (request , response) => {
    try {
...
/*
    ...
    Fields : no-fields
 */
router.get('/contactDetails/:id', async (request , response) => {
    try {
 ...
 */
router.post('/contactDetails', async (request , response) => {
    try {
        let newProduct = {
...
/*
    ...
    Fields : name , image , price , qty , info
 */
router.put('/contactDetails/:id', async (request , response) => {
    let productId = request.params.id;
    try {
        let updatedProduct = {
            name : request.body.name,
...
/*
    ...
    Fields : no-fields
 */
router.delete('/contactDetails/:id', async (request, response) => {
    try{
        let productId = request.params.id;
        // product is exists or not
        let product = await Product.findById(productId);
